...
;(function($) {
	...
	function productViewEvents() {
        ...
        if($(document.body).hasClass('catalog-product-view')) {
        	$('.catalog-product-view .product-collateral *').removeAttr('style');
        	$('.catalog-product-view .product-collateral br').remove();
        	$('.catalog-product-view .product-collateral .std hr:first-child').remove();
        	$('.catalog-product-view .product-collateral .std hr').first().remove();
			$('.catalog-product-view .product-collateral p').each(function() {
	...
	function cmsEvents() {
		...
		if($(document.body).hasClass('cms-page-view')) {
        	$('.cms-page-view .std *').removeAttr('style');
        	$('.cms-page-view .std *').removeAttr('align');
        	$('.cms-page-view .std br').remove();
        	$('.cms-page-view .std p').each(function() {
				if($(this).text() == '' || $(this).text() == ' ') {
					$(this).remove();
				}
			});
