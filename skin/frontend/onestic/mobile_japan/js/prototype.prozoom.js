...
Prozoom = function(selector, options){
    ...
    return $$(selector).each(function(el) {
        ...
        $$('a.prozoom-small-image').each(function(el){ //@todo make possibility of multiple instances 
        ...
        function showLargeImage(e) //@todo implement lightbox class
        {
            e.stop();
            var link = e.element();
            ...
            image.onload = function(){
                ...
                Event.observe($(largeimage), 'click', $(largeimage).remove);
            }
            image.src = link.href;
        ...
        function Lens(){
            ...
            this.node.addClassName('zoom-lens'); //IE8 fix
        ...
        Lens.prototype.remove = function(){
            ...
            if (settings.zoomType == 'innerzoom') {
                ...
                this.node.remove(); //@todo replace with hide
            }
        };
        ...
        Largeimage.prototype.setinner = function(e){
            var left = Math.ceil(-scale.x * Math.abs(e.pageX - smallimagedata.pos.l));
            if (Math.abs(left) > (this.node.width - smallimagedata.w)) {
                left = -(this.node.width - smallimagedata.w);
            }
            var top = Math.ceil(-scale.y * Math.abs(e.pageY - smallimagedata.pos.t));
        ...
        function Stage(){
            ...
            this.node.addClassName('zoom-window'); //IE8 fix
        ...
        function zoomTitle(){
            ...
            this.node.addClassName('zoom-title'); //IE8 fix
        ...
        function Loader(){
            ...
            this.node.addClassName('spinner'); //IE8 fix
            document.body.appendChild(this.node);
        ...
        function Informer(){
            ...
            this.node.addClassName('informer'); //IE8 fix
