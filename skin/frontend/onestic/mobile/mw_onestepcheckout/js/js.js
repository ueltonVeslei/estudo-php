...
$MW_Onestepcheckout(function(){
		...
		setInterval(function(){
			$MW_Onestepcheckout('#onestep_form').find('input').each(function(){
				if($MW_Onestepcheckout(this).val() == 'n/a' || $MW_Onestepcheckout(this).val() == 'undefined' 
					|| $MW_Onestepcheckout(this).val() == 'null'
						|| $MW_Onestepcheckout(this).val() == '.' 
							|| $MW_Onestepcheckout(this).val() == 'street is null' 
								|| $MW_Onestepcheckout(this).val() == 'n/a n/a'){
					$MW_Onestepcheckout(this).val('');
				}
			});
		},3000);
		...
		$MW_Onestepcheckout("#ship_to_same_address").click(function(){
			...
			if(this.checked==true){
					...
					$MW_Onestepcheckout('#ship_to_same_address_observe').val(0);
					if(islogin){
					 ...
					 this.value=1;	
					 $MW_Onestepcheckout('#ship_to_same_address_observe').val(1);
