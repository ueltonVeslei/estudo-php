...
function nexting(step){
	...
	if( step == 'shipping' ){
		...
		document.getElementById('identificacao').className = 'step';
		document.getElementById('envio').className = 'step active';
		
		document.getElementById('opc-shipping').className = 'section allow active';
		document.getElementById('checkout-step-shipping').style.display = 'block';
	}
	else if( step == 'shipping_method' ){
		document.getElementById('opc-shipping').className = 'section allow';
		document.getElementById('checkout-step-shipping').style.display = 'none';
		
		document.getElementById('opc-shipping_method').className = 'section allow active';
		document.getElementById('checkout-step-shipping_method').style.display = 'block';
	}
	else if( step == 'payment' ){
		document.getElementById('opc-shipping_method').className = 'section allow';
		document.getElementById('checkout-step-shipping_method').style.display = 'none';
		
		document.getElementById('envio').className = 'step';
		document.getElementById('pagamento').className = 'step active';
		
		document.getElementById('opc-payment').className = 'section allow active';
		...
		document.getElementById('pagamento').className = 'step';
		document.getElementById('confirmacao').className = 'step active';
		
		document.getElementById('opc-review').className = 'section allow active';
...
ShippingMethod.prototype = {
    ...
    validate: function() {
        ...
        if (methods.length==0) {
			...
			alert(Translator.translate('Seu pedido não pode ser finalizado por não ter método de envio disponível. Por favor faça alterações no endereço de envio informado.'));
            return false;
        }
		...
		alert(Translator.translate('Por favor especifique um método de envio.'));
        return false;
    },
...
Payment.prototype = {
    ...
    validate: function() {
        ...
        if (methods.length==0) {
			...
			alert(Translator.translate('Seu pedido não pode ser finalizado por não ter método de pagamento disponível.'));
            return false;
        }
        for (var i=0; i<methods.length; i++) {
            if (methods[i].checked) {
