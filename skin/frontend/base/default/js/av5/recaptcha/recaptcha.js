...
jQuery(function() {
    ...
    Av5.reCAPTCHA = function() {
        ...
        var _bindEvents = function() {
            ...
            av5RecaptchaCallback = function(response) {
		        	...
		        	_form.each(function(index) {
		                _form[index].on('submit', function () {
		                    ...
		                    if (response.length === 0) {
		                        ...
		                        jQuery('div.g-recaptcha',jQuery(this)).append('<input type="hidden" name="av5_recaptcha" value="1">');
