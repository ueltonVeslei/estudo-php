 ...
 */
class Saffira_Koin_Model_WebServiceOrder extends Saffira_Koin_Model_WebService {
	public $reference;
	public $currency;
	public $requestDate;
	public $price;
	...
	private function _getAdditionalInfoBuyer(){
		$tipo_pessoa_juridica = Mage::getModel('Saffira_Koin/Buyer')->getTipoPessoaJuridica();
	...
	private function _getItems(){
		...
		foreach ($this->items as $item){
			$item = array(
				...
				'Price'       => Mage::helper('Saffira_Koin')->formatarValorKoin($item->getProduct()->getFinalPrice()),
