 ...
 */
class Saffira_Koin_PayController extends Mage_Core_Controller_Front_Action {
	/**
	...
	public function verifyAction(){
		...
		$block = $this->getLayout()->getBlock('Saffira_Koin.success');
	...
	{
		$koinStatus = Mage::getStoreConfig('payment/Saffira_Koin_Standard/processing_order_status', $order->getStoreId());
		if ($koinStatus) {
