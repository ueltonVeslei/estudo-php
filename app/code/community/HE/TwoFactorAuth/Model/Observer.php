    ...
    public function check_twofactor_active($observer)
    {
        ...
        if (Mage::getSingleton('admin/session')->get2faState() != HE_TwoFactorAuth_Model_Validate::TFA_STATE_ACTIVE) {
            ...
            $msg = Mage::helper('he_twofactorauth')->__(
                'Precisamos validar seu acesso com o Aplicativo Google Authenticator.'
            );
            ...
            if (Mage::helper('he_twofactorauth')->getProvider() == 'google') {
                ...
                $fieldset->addField(
                    'checkbox', 'checkbox', array(
                                  ...
                                  'value'              => '1',
                                  'disabled'           => false,
                                  'after_element_html' => '<small>Marque essa op&ccedil;&atilde;o para resetar o Google Authenticator desse usu&aacute;rio.<br />Ser&aacute; necess&aacute;rio utilizar o QR code novamente para liberar o acesso ao painel.</small>',
                                  'tabindex'           => 1
                              )
                );
            }
