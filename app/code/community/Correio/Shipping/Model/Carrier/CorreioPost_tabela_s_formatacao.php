    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
	...
	protected function _getTracking($code) {
		$error = Mage::getModel('shipping/tracking_result_error');
                ...
                $content = mb_convert_encoding(file_get_contents("http://websro.correios.com.br/sro_bin/txect01$.Inexistente?P_LINGUA=001&P_TIPO=002&P_COD_LIS=" . $code), 'ISO-8859-1');
