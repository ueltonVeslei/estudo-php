    ...
    */
    ...
    private function getCustomStoreCollection(){
        ...
        $sql .= "
                ...
                LEFT JOIN catalog_product_entity_decimal AS CDL ON (CDL.entity_id = catalog_product_flat_1.entity_id AND CDL.attribute_id = 567)";
        $sql .= $sql_join;
        $sql .= "
...
//            endforeach;
            ...
            $preco_final = ($_product['special_price_real'])?$_product['special_price_real']:$_product['price']; // $product['special_price_real'] ? $product['special_price_real'] : $product['price'];
