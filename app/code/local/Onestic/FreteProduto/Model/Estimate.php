 ...
 *
 */
class Onestic_FreteProduto_Model_Estimate
{
	/**
	 * Customer object,
	...
	public function estimate()
	{
		...
		if (!($product instanceof Mage_Catalog_Model_Product) || !$product->getId()) {
			Mage::throwException(
				Mage::helper('onestic_freteproduto')->__('Please specify a valid product')
			);
		}

		if (!isset($addressInfo['country_id'])) {
			Mage::throwException(
				Mage::helper('onestic_freteproduto')->__('Please specify a country')
			);
		}
