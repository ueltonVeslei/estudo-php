 ...
 *
 */
class Onestic_FreteProduto_Block_Estimate_Form extends Onestic_FreteProduto_Block_Estimate_Abstract
{
    /**
    ...
    {
        return $this->getUrl('onestic_freteproduto/estimate/estimate', array('_current' => true));
    }
