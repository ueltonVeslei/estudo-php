<?php
class Onestic_ApiServer_Block_Adminhtml_Product extends Mage_Adminhtml_Block_Widget_Grid_Container {
		
	public function __construct()
	{
		parent::__construct();
		$this->_controller = 'adminhtml_product';
		$this->_blockGroup = 'onestic_apiserver';
		$this->_headerText = Mage::helper('onestic_apiserver')->__('Produtos Roche');
