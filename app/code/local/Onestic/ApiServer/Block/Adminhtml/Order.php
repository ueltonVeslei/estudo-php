<?php
class Onestic_ApiServer_Block_Adminhtml_Order extends Mage_Adminhtml_Block_Widget_Grid_Container {
	...
	public function __construct()
	{
		...
		$this->_headerText = Mage::helper('onestic_apiserver')->__('Pedidos Roche');
