...
class MageWorx_Adminhtml_Block_Productplus_Product_Edit_Tab_Renderer_Price  extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
		$block = Mage::app()->getLayout()
			->createBlock('mageworx/productplus_sales_items_default')
			->setTemplate('productplus/purchases/grid-renderer-price.phtml')
