...
class AW_Advancedsearch_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const SPHINX_REINDEX = 'awadvancedsearch/sphinx/full_reindex';
    ...
    public static function getSphinxFullReindex()
    {
        return Mage::getStoreConfig(self::SPHINX_REINDEX);
    }
    ...
    {
        return array('addr' => self::getSphinxServerAddr(),
                     'port' => self::getSphinxServerPort(),
                     'reindex' => self::getSphinxFullReindex());
    }
}
