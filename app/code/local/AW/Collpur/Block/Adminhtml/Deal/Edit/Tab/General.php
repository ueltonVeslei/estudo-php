...
class AW_Collpur_Block_Adminhtml_Deal_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('maximum_allowed_purchases', 'text', array(
            ...
            'after_element_html' => 'Deixar vazio para ilimitado',
        ));
        ...
        $fieldset->addField('url_key', 'text', array(
            ...
            'after_element_html' => 'Deixar vazio para usar a URL do produto relacionado. Nota, somente símbolos latinos, numeros, hífen e underscore são permitidos como chaves url',
        ));
