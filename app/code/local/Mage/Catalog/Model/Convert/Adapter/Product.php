    ...
    extends Mage_Eav_Model_Convert_Adapter_Entity
{
    ...
    public function load()
    {
        ...
        $attrFilterArray ['frete_gratis']   = 'eq';
        $attrFilterArray ['frete_gratis_dropdown']   = 'eq';
        $attrFilterArray ['garantia_numero']= 'eq';
        $attrFilterArray ['composicao_new'] = 'like';
        $attrFilterArray ['nr_ministerio_da_saude'] = 'like';
        $attrFilterArray ['voltagem']       = 'eq';
        $attrFilterArray ['manufacturer']   = 'eq';
