 ...
 * @author     AV5 Tecnologia <anderson@av5.com.br>
 */
class Av5_Correiospro_Model_Resource_Promos_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
	...
	public function addServiceFilter($service){
		$this->addFieldToFilter('servico', array('like' => '%'.$service.'%'));
		return $this;
	}
