...
class Edrone_Base_Model_Utilities_EdroneEventOrderCancel extends Edrone_Base_Model_Utilities_EdroneEvent
{

    public function init()
    {
        $this->field['action_type'] = 'order_cancel';
    }
    ...
    {
        return new Edrone_Base_Model_Utilities_EdroneEventOrderCancel();
    }
