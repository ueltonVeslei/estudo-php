...
class Biostore_Msterms_Block_Catalog_Search_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            ...
            // Obtem todas as lojas e adiciona a opcao Todas as Lojas
            $opcao_lojas = Mage::getSingleton('adminhtml/system_store')->getStoreValuesForForm(true, false);
            $opcao_extra = array(0 => array('label' => 'Todas as lojas', 'value' => 0)); 
            $stores = array_merge($opcao_extra, $opcao_lojas);
