...
//     }
// }
class Biostore_Linkrastreamento_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * Allowed hash keys
     *
    ...
    protected function _getTrackingUrl($key, $model, $method = 'getId')
    {
         ...
         return $storeModel->getUrl('linkrastreamento/tracking/popup', $param);
    }
    ...
    public function getTrackingPopUpUrlByTrackId($track = '')
    {
        ...
        return $this->_getTrackingUrl('track_id', $track);
    }
...
/*        if ($ship && !is_object($ship)) {
    ...
    public function getTrackingAjaxUrl()
    {
        return $this->_getUrl('linkrastreamento/tracking/ajax');
    }
