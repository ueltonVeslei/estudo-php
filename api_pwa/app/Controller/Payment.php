...
class Controller_Payment extends Controller {
    ...
    protected $_messages = [
        ['Credit card type is not allowed for this payment method.','Tipo de cartão de crédito não aceito.'],
        ['Please select your credit card type.','Por favor, selecione o tipo de cartão de crédito.'],
        ['Please enter your credit card holder name.','Por favor, informe o nome do titular do cartão de crédito.'],
        ['Invalid Credit Card Number','Número do cartão de crédito inválido.'],
        ['Incorrect credit card expiration date.','Data de expiração incorreta.'],
        ['Not all products are available in the requested quantity','Alguns produtos não possuem estoque no momento.'],
        ['Lock wait timeout exceeded','Não conseguimos processar o seu pedido no momento, por favor tente novamente.'],
        ['Integrity constraint violation','Não conseguimos processar o seu pedido no momento, por favor tente novamente.'],
