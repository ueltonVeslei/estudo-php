<?php
class Controller_Paymentteste extends Controller {
        ...
        if ($body = $this->getData('body')) {    
            ...
            if (isset($body->payment_data)) {
                ...
                $quote->getPayment()->importData($paymentData + [
                    ...
                    'mundipagg_creditcard_new_credito_parcelamento_1_1' => '' . $paymentData['mundipagg_creditcard_new_credito_parcelamento_1_1']
                ]);
                $quote->assignCustomer($customer);

                Mage::app()->getRequest()->setParam('payment', $paymentData);
